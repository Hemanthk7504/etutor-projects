...
SECRET_KEY = 'django-insecure-mx#nx#=6%r==ec%m$qvuv5z++fx19wietw-$6d%awyl01_*zjg'
...
EMAIL_HOST_PASSWORD = 'ziowfzfx yhuymchh'
GRAPHQL_AUTH = {
    "EMAIL_ASYNC_TASK": "donations.pseudo_async_email_support.pseudo_async_email_suppot"
}
